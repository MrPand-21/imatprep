    ...
    return (
        <>
            <Section className="relative overflow-hidden pb-12 pt-16 sm:pb-16 sm:pt-20">
                <div className="pointer-events-none absolute top-0 -left-20 h-56 w-56 rounded-full bg-secondary/28 blur-3xl" />
                    <motion.div
                    ...
                    >
                        <div>
                            ...
                            <h1 className="mt-4 max-w-3xl text-4xl leading-[0.96] tracking-tight sm:text-6xl">
                                A disciplined method with emotional calm and tactical precision.
                            </h1>
            ...
            <Section className="py-8 sm:py-12">
                    <div className="space-y-4 border-y border-border/70 py-10">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        {principles.map((principle, index) => (
                            <motion.article
                                ...
                                className="rounded-2xl border border-border/80 bg-surface p-5"
                            >
                                <h3 className="text-2xl tracking-tight">{principle.title}</h3>
                ...
                <div className="grid gap-9 lg:grid-cols-[0.72fr_1.28fr]">
                    <div className="lg:sticky lg:top-28 lg:self-start">
                        ...
                        <p className="mt-4 max-w-md text-base text-muted-foreground sm:text-lg">
                            ...
                            <div className="mt-8 space-y-2 border-l border-border/60 pl-4">
                    ...
                    <div className="space-y-4">
                        {processSteps.map((step, index) => (
                            ...
                            >
                                ...
                                <h3 className="mt-2 text-3xl tracking-tight">{step.title}</h3>
